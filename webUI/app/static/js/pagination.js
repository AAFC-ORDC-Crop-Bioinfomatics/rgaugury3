(function ($) {
    ...
    $.fn.dataTableExt.oPagination.input = {
        'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
            ...
            nFirst.className = firstClassName + ' ' + classes.sPageButton +'btn btn-primary';
            nPrevious.className = previousClassName + ' ' + classes.sPageButton+'btn btn-primary';
            nNext.className = nextClassName + ' ' + classes.sPageButton+'btn btn-primary';
            nLast.className = lastClassName + ' ' + classes.sPageButton+'btn btn-primary';
